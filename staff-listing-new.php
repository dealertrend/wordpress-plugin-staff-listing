...
class DTStaffListing {
  var $meta_fields = array("staff-title");
    ...
    switch ($column)
    {
      ...
      case "dt_departments":
        ...
        foreach ($departments as $department)
          array_push($departments_html, '<a href="' . get_term_link($department->slug, "departments") . '">' . $department->name . '</a>');        
  ...
  function template_redirect()
  {
    ...
    if ($wp_query->query_vars["post_type"] == "dt_staff" || $wp_query->query_vars["taxonomy"] == "departments" || $wp_query->query_vars['category_name'] == "staff")
    {
  ...
  function admin_init() 
  {
    ...
    add_meta_box("dt-meta", "Position or Title", array(&$this, "meta_options"), "dt_staff", "normal", "high");
  }
